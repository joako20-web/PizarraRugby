...
export const Renderer = {
    ...
    /**
     * Dibuja un frame interpolado para animaci�n
    ...
    drawZones() {
        state.canvas.zones.forEach(zone => {
            ...
            // Dibujo del rect�ngulo de la zona
            ctx.globalAlpha = 0.3;
    ...
    /**
     * Dibuja las l�neas de trayectoria
    ...
    drawKickArrow(arrow) {
        ...
        // Control point para la curva cuadr�tica
    ...
    /**
     * Dibuja la l�nea de trail activa durante el drag
     */
    drawActiveDragTrail() {
    ...
    /**
     * Dibuja el bal�n
     * @param {Object} ball - Objeto del bal�n
     */
    drawBall(ball) {
    ...
    /**
     * Dibuja jugadores interpolados para animaci�n
     * @param {Object} frameA - Frame inicial
     * @param {Object} frameB - Frame final
     * @param {number} t - Factor de interpolaci�n (0-1)
     */
    ...
    /**
     * Dibuja bal�n interpolado para animaci�n
     * @param {Object} ballA - Bal�n en frame A
     * @param {Object} ballB - Bal�n en frame B
     * @param {number} t - Factor de interpolaci�n (0-1)
     */
