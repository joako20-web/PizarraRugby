...
export const SettingsUI = {
        ...
        const html = `
            <div class="settings-container">
                <div class="settings-sidebar">
                    <button class="settings-tab active" data-tab="general" data-i18n="settings_tab_general">
                        ...
                        ${I18n.t('settings_tab_general')}
                    </button>
                    <button class="settings-tab" data-tab="shortcuts" data-i18n="settings_tab_shortcuts">
                        <svg class="icon icon--sm" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6A2.25 2.25 0 016 3.75h2.25A2.25 2.25 0 0110.5 6v2.25a2.25 2.25 0 01-2.25 2.25H6a2.25 2.25 0 01-2.25-2.25V6zM3.75 15.75A2.25 2.25 0 016 13.5h2.25a2.25 2.25 0 012.25 2.25V18a2.25 2.25 0 01-2.25 2.25H6A2.25 2.25 0 013.75 18v-2.25zM13.5 6a2.25 2.25 0 012.25-2.25H18A2.25 2.25 0 0120.25 6v2.25A2.25 2.25 0 0118 10.5h-2.25a2.25 2.25 0 01-2.25-2.25V6zM13.5 15.75a2.25 2.25 0 012.25-2.25H18a2.25 2.25 0 012.25 2.25V18A2.25 2.25 0 0118 20.25h-2.25A2.25 2.25 0 0113.5 18v-2.25z" /></svg>
                        ${I18n.t('settings_tab_shortcuts')}
                    </button>
                    <button class="settings-tab" data-tab="layout" data-i18n="settings_tab_layout">
            ...
            <div style="display: flex; flex-direction: column; gap: 15px;">
                ...
                <div class="form-group">
                    ...
                    <select id="set-theme" style="width:100%; height:40px;">
                        <option value="dark" ${SETTINGS.THEME === 'dark' ? 'selected' : ''}>${I18n.t('settings_theme_dark')}</option>
                        <option value="light" ${SETTINGS.THEME === 'light' ? 'selected' : ''}>${I18n.t('settings_theme_light')}</option>
                    </select>
                </div>
                <div class="form-group">
    ...
    saveGeneralSettings() {
        ...
        if (nameA) {
            ...
            if (language !== I18n.currentLocale) {
                ...
                // Update Popup Title if it exists
                const popupTitle = document.getElementById('popup-title');
                if (popupTitle) popupTitle.textContent = I18n.t('settings_title');
            }
    ...
    showResetConfirmation() {
        ...
        overlay.innerHTML = `
            <h3 style="color:white; margin-bottom:15px;">${I18n.t('settings_reset_confirm_title')}</h3>
            <p style="color:#ccc; font-size:14px; margin-bottom:20px;">${I18n.t('settings_reset_confirm_text')}</p>
            <div style="display:flex; gap:10px;">
                <button id="confirm-reset-yes" class="btn btn--danger">${I18n.t('settings_reset_confirm_btn')}</button>
                <button id="confirm-reset-no" class="btn btn--secondary">${I18n.t('popup_cancel')}</button>
            </div>
        `;
        ...
        document.getElementById("confirm-reset-yes").onclick = () => {
            const defaults = {
                TEAM_A_COLOR: '#0000ff',
                TEAM_B_COLOR: '#ff0000',
                TEAM_A_NAME: I18n.t('default_team_a'),
                TEAM_B_NAME: I18n.t('default_team_b'),
                THEME: 'dark',
                PLAYER_SCALE: 1.0,
                SHOW_NUMBERS: true,
                BALL_SCALE: 1.0,
